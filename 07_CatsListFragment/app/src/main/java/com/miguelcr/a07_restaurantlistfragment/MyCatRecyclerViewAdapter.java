...
public class MyCatRecyclerViewAdapter extends RecyclerView.Adapter<MyCatRecyclerViewAdapter.ViewHolder> {

    private Context ctx;
    private final List<Cats> mValues;

    public MyCatRecyclerViewAdapter(Context context, List<Cats> items) {
        ctx = context;
        mValues = items;
    }
